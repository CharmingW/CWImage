...
public class BuilderManager {
    ...
    public BuilderManager(View parent) {
        ...
        textSize = (int) (16 * density);
        radius = (int) (40 * density);
            ...
            SimpleCircleButton.Builder builder = new SimpleCircleButton
                    ...
                    .normalImageDrawable(new Drawable() {
                        ...
                        public void draw(@NonNull Canvas canvas) {
                            ...
                            canvas.drawText(name, radius - bounds.width() / 2, radius + bounds.height() / 2, paint);
                        }
    ...
    private void setupFunMenu(int channel) {
        ...
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(-w - hm, -h_1_5 - vm_1_5 + offset));
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(0, -h_1_5 - vm_1_5 + offset));
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(+w + hm, -h_1_5 - vm_1_5 + offset));

        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(-w - hm, -h_0_5 - vm_0_5 + offset));
    ...
    private void setupWallPaperMenu(int channel) {
        ...
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(-w - hm, -h_2_5 - vm_2_5 - offset));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(0, -h_2_5 - vm_2_5 - offset));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(+w + hm, -h_2_5 - vm_2_5 - offset));

        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(-w - hm, -h_1_5 - vm_1_5 - offset));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(0, -h_1_5 - vm_1_5 - offset));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(+w + hm, -h_1_5 - vm_1_5 - offset));

        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(-w - hm, -h_0_5 - vm_0_5 - offset));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(0, -h_0_5 - vm_0_5 - offset));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(+w + hm, -h_0_5 - vm_0_5 - offset));
...
//        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(0, +h_1_5 + vm_1_5));
        ...
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(-w - hm, -h_2_5 - vm_2_5 - offset));
    ...
    private void setupPetMenu(int channel) {
        ...
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(-w / 2 - hm / 2, +h_0_5 + vm_0_5));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(+w / 2 + hm / 2, +h_0_5 + vm_0_5));
        ...
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(-w / 2 - hm / 2, +h_0_5 + vm_0_5));
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(+w / 2 + hm / 2, +h_0_5 + vm_0_5));
...
//        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(0, +h_1_5 + vm_1_5));
    ...
    private void setupGoMenu(int channel) {
        ...
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(-w / 2 - hm / 2, +h_0_5 + vm_0_5 + offset));
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(+w / 2 + hm / 2, +h_0_5 + vm_0_5 + offset));
    ...
    private void setupPhotographMenu(int channel) {
        ...
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(-w / 2 - hm / 2, +h_1_5 + vm_1_5));
        mBoomMenuButton.getCustomButtonPlacePositions().add(new PointF(+w / 2 + hm / 2, +h_1_5 + vm_1_5));
        ...
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(-w / 2 - hm / 2, +h_1_5 + vm_1_5));
        mBoomMenuButton.getCustomPiecePlacePositions().add(new PointF(+w / 2 + hm / 2, +h_1_5 + vm_1_5));
    }
